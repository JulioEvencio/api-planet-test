...
public class CustomRestExceptionHandler {
	...
	public ResponseEntity<ApiMessageError> handlerPlanetNotFoundException(PlanetNotFoundException e) {
		ApiMessageError errors = new ApiMessageError("Planet Not Found", Arrays.asList(e.getMessage()));

		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errors);
	}

	@ExceptionHandler(DataIntegrityViolationException.class)
	public ResponseEntity<ApiMessageError> handlerDataIntegrityViolationException(DataIntegrityViolationException e) {
		ApiMessageError errors = new ApiMessageError("Invalid data", Arrays.asList(e.getMessage()));
	...
	public ResponseEntity<ApiMessageError> handlerMethodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		ApiMessageError error = new ApiMessageError("Invalid Date", errors);
